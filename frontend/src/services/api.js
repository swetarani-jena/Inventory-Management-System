...
export const api = {
  ...
  // Inventory
  getInventory:    (params = {}) => get(`/inventory${toQuery(params)}`),
  ...
  // Requisitions
  getRequisitions:    (params = {}) => get(`/requisitions${toQuery(params)}`),
  ...
  // Purchase Orders
  getPurchaseOrders:   (params = {}) => get(`/purchase-orders${toQuery(params)}`),
